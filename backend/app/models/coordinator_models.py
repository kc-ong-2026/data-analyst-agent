...
class WorkflowStep(BaseModel):
    ...
    inputs: list[str] = Field(default_factory=list, description="Required inputs for this step")
...
class WorkflowPlan(BaseModel):
    ...
    query_understanding: str = Field(..., description="Interpretation of the user's request")
...
class DelegationInfo(BaseModel):
    ...
    next_agent: str = Field(..., description="Name of the next agent to handle the task")
